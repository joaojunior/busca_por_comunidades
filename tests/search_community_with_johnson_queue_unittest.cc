...
TEST(SearchComunityTest, VerifyQuantityShortestPathInEdgeWithJohnsonQueue){
    Graph graph;
    JohnsonResult *floyd_warshall_result;
    ...
    floyd_warshall_result = johnson_queue(&graph);
...
TEST(SearchComunityTest, CalculateCommunitiesWithJohnsonQueueWith1Community){
    Graph graph;
